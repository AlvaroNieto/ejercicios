...
•	Body,  hace referencia al cuerpo del HTML.  En este elemento se encuentra todo el contenido del documento HTML, tales como el texto,  hipervínculos, imágenes, tablas, listas, etc.

•	h1 y h2, son los cabeceros del documento. Van desde h1, siendo este el título más importante a h6, el que menos.

•	hr or hard rule, marca un cambio en el estilo del documento. Se usa para marcar o definir el contenido del HTML.

•	p, hace referencia a los parágrafos.

•	El elemento div genera una división en el documento. Se usa para agrupar elementos en bloque y darles formato en CSS.

•	a, define a un hiperfinculo.
...
En la versión inglesa, ¿por qué los últimos 5 párrafos se muestran de forma diferente que los 2 primeros?
 ...
 Porque los dos primeros párrafos tienen añadido “class=verse” mientras que en el resto no. 
